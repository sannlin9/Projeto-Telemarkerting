...
def main():
    ...
    st.set_page_config(page_title = 'Telemarketing analisys', \
        page_icon = 'https://st2.depositphotos.com/3027583/6491/v/600/depositphotos_64919923-stock-illustration-male-and-female-cTodos-center.jpg',
        layout="wide",
    ...
    if (data_file_1 is not None):
        ...
        with st.sidebar.form(key='my_form'):
            ...
            default_selected =  st.multiselect("Default", default_list, ['Todos'])

            
            # TEM FINANCIAMENTO IMOBILIÁRIO?
            housing_list = bank.housing.unique().tolist()
            housing_list.append('Todos')
            housing_selected =  st.multiselect("Tem financiamento imob?", housing_list, ['Todos'])
            ...
            day_of_week_selected =  st.multiselect("Dia da semana", day_of_week_list, ['Todos'])
